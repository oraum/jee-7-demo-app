node {
    ...
    stage('To k8s') {
        sh "curl http://172.17.0.1:8080/apis/extensions/v1beta1/namespaces/default/deployments -X POST -H'Content-Type: application/json' -d @wasliberty/jeedemo-deployment.json"
    }
}
